...
var coinsGroup,coin1Img,coin2Img,coin3Img;
...
function preload(){
  ...
  coin1Img = loadImage("assets/Coin.png");
  coin2Img = loadImage("assets/Wallet_Of_Coins.png");
  coin3Img = loadImage("assets/Sack_Of_Coins.png");
}
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if(coinsGroup.isTouching(kangaroo)){
      score = score + 30;
...
function spawnShrubs() {
  ...
  function spawnCoins() {
    ...
    if (frameCount % 150 === 0) {
      ...
      var coin = createSprite(camera.position.x+300,330,40,10);
